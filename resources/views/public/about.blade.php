...
<section class="max-w-7xl mx-auto px-6 pt-28 pb-20">
    <div class="max-w-3xl">
        ...
        <p class="mt-6 text-lg text-slate-600 leading-relaxed">
            Staffing App was built to solve a simple but persistent problem: managing hiring requirements should not feel chaotic, fragmented, or manual.
        </p>
    </div>
</section>
...
<section class="py-28">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="max-w-2xl mb-16">
            <h2 class="text-3xl font-bold tracking-tight text-slate-900">
                Who Staffing App is for
            </h2>
            <p class="mt-4 text-lg text-slate-600">
                Staffing App is designed for teams that value clarity and accountability in their hiring process.
            </p>
        </div>
